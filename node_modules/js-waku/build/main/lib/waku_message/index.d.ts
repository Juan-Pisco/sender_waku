...
export declare enum DecryptionMethod {
...
export declare class WakuMessage {
     ...
     */
    static decode(bytes: Uint8Array, decryptionKeys?: Array<{
        key: Uint8Array;
     ...
     * key until the message is decrypted or combinations are run out.
     */
    static decodeProto(protoBuf: proto.WakuMessage, decryptionKeys?: Array<{
        key: Uint8Array;
        method?: DecryptionMethod;
