...
export class WakuRelay extends Gossipsub {
    constructor(libp2p, options) {
        ...
        this.pubSubTopic = (options === null || options === void 0 ? void 0 : options.pubSubTopic) || DefaultPubSubTopic;
    ...
    send(message) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield _super.publish.call(this, this.pubSubTopic, Buffer.from(msg));
        });
    }
    /**
